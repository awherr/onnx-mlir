...
//====---------------- NxHelper.hpp - Nx Dialect Helper----------------===//
//
// // Copyright 2025 Intel Labs.
//
// =============================================================================
//
// This file implements helper methods to build Nx Dialect ops.
//
//===----------------------------------------------------------------------===//

#ifndef ONNX_MLIR_DEN_HELPER_H
#define ONNX_MLIR_DEN_HELPER_H
...
struct NxIterateOperandPack {
  NxIterateOperandPack(mlir::Builder &builder,
